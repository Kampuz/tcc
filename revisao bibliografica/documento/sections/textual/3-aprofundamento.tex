...
\begin{figure}[H]
    ...
    \fonteimagem{Fonte: Vinicius Soares de Silveira}
...
\begin{enumerate}
    \item \textbf{Reaproveitamento do conhecimento existente:} o modelo pré-treinado mantém sua capacidade de reconhecer padrões aprendidos anteriormente, funcionando como uma base de conhecimento.
...
\begin{figure}[H]
    ...
    \fonteimagem{Fonte: Free Time Learn}
...
\begin{figure}[H]
    ...
    \fonteimagem{Fonte: Martin Andreoni}
...
\begin{figure}[H]
    ...
    \fonteimagem{Fonte: Jingxin Liang et al.}
