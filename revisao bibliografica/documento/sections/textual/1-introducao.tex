...
O setor ferroviário possui papel estratégico no transporte de cargas e passageiros no mundo todo, estudos recentes destacam o potencial do modal ferroviário para aumenter a eficiência logística e reduzir custos operacionais, além de contribuir para a mobilidade sustentável.
...
Tradicionalmente, inspeções ferroviárias são realizadas por equipes especializadas, de for\-ma manual e periódica. Embora essencial, esse processo acaba por lento, subjetivo e custoso, chegando a representar mais de 50\% dos custos totais de manutenção em alguns países \cite{HUANG201846}. Além do mais, a depêndencia exclusiva da inspeção humana dificulta a detecção precoce de falhas em redes extensas ou de díficil acesso.
