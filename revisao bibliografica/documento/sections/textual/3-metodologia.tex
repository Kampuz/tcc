...
\subsubsection{sobre o dataset}

O dataset que será utilizado neste trabalho será \textit{Railway Track fault Detection Resized (224 X 224)}, disponibilizado na plataforma Kaggle por \textcite{gpiosenka_railway_2022}.
...
\subsubsection{dados do dataset}

O conjunto contém 384 imagens de trilhos, sendo metade correspondente a trilhos defei\-tuosos e a outra metade a trilhos em boas condições.
Ele é dividido em x imagens de treinamento, x imagens de teste e x imagens de validação, apresentadas três categorias de anomalias: ausência de pinos de fixação, deformações e rachaduras nos trilho e danos na fundação do trilho (parte de madeira transversal ao trilho).
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        ...
        \caption{Ausência de pino superior}
        \label{fig:img2}
    \end{subfigure}

    \vspace{0.25cm} % Espaço entre linhas
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        ...
        \caption{deformação nos trilhos}
        \label{fig:img4}
    \end{subfigure}
...
Os modelos que serão utilizados serão:
